declare namespace MinecraftData {
  ...
  export interface SupportsFeature {
    ...
    /** `1.21.3 - latest`
     * entity_teleport carries velocity, float rotation and relative flags like the player position packet */
    "entityTeleportHasRelativeFlags": boolean;
    /** `1.21.9 - latest`
    ...
    /** `26.1 - latest`
     * use_entity carries the hit location, replacing the interact_at then interact pair */
    "useEntityHasLocation": boolean;
    /** `1.8 - 1.8.9`
